...
public class cardView3 extends AppCompatActivity {
    ...
    ImageView[] images; //just one smoothie picture
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images[0] = findViewById(R.id.smoothiepicture);
        ...
        textViews[0] = findViewById(R.id.smoothie);
        ...
        imageRefs[0] = database.getReference("imagesmoothie");

        textRefs[0] = database.getReference("textsmoothieitem");
        textRefs[1] = database.getReference("textsmoothiecost");
        textRefs[2] = database.getReference("textsmoothieportion");
        textRefs[3] = database.getReference("smoothietimetaken");
        textRefs[4] = database.getReference("textsmoothiecalories");
        textRefs[5] = database.getReference("textsmoothiestar");
        textRefs[6] = database.getReference("textsmoothiedesc");
        textRefs[7] = database.getReference("textsmoothienoofcups");
        textRefs[8] = database.getReference("textsmoothietotalcost");
