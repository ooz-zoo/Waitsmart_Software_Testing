...
public class BeveragesPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference1.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value1, @Nullable FirebaseFirestoreException error) {
                ...
                String ratingString = value1.getString("rating");
                if (ratingString != null) {
                    float rating = Float.parseFloat(ratingString);
                    ratingBar_one.setRating(rating);
                } else {
                    ratingBar_one.setRating(0); // Set a default rating value
                    ratingBar_one.setContentDescription("Rating not available"); // Display a message or placeholder
                }
        ...
        documentReference2.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                String ratingString = value.getString("rating");
                if (ratingString != null) {
                    float rating = Float.parseFloat(ratingString);
                    ratingBar_two.setRating(rating);
                } else {
                    ratingBar_two.setRating(0); // Set a default rating value
                    ratingBar_two.setContentDescription("Rating not available"); // Display a message or placeholder
                }
        ...
        documentReference3.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (ratingString != null) {
                    float rating = Float.parseFloat(ratingString);
                    ratingBar_three.setRating(rating);
                } else {
                    ratingBar_three.setRating(0); // Set a default rating value
                    ratingBar_three.setContentDescription("Rating not available"); // Display a message or placeholder
                }
        ...
        documentReference4.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (ratingString != null) {
                    float rating = Float.parseFloat(ratingString);
                    ratingBar_four.setRating(rating);
                } else {
                    ratingBar_four.setRating(0); // Set a default rating value
                    ratingBar_four.setContentDescription("Rating not available"); // Display a message or placeholder
                }
        ...
        documentReference5.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (ratingString != null) {
                    float rating = Float.parseFloat(ratingString);
                    ratingBar_five.setRating(rating);
                } else {
                    ratingBar_five.setRating(0); // Set a default rating value
                    ratingBar_five.setContentDescription("Rating not available"); // Display a message or placeholder
                }
