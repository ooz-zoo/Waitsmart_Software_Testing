...
public class cardView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images[0] = findViewById(R.id.mojitopicture);
        ...
        textViews[0] = findViewById(R.id.mojito);
        ...
        imageRefs[0] = database.getReference("imagemojito");

        textRefs[0] = database.getReference("textmojito");
        textRefs[1] = database.getReference("textmojitokes");
        textRefs[2] = database.getReference("textmojitoportion");
        textRefs[3] = database.getReference("textmojitotimetaken");
        textRefs[4] = database.getReference("textmojitocalories");
        textRefs[5] = database.getReference("textmojitostar");
        textRefs[6] = database.getReference("textmojitodesc");
        textRefs[7] = database.getReference("textmojitonoofcups");
        textRefs[8] = database.getReference("textmojitototalcost");
        ...
        for (int k = 0; k < textViews.length; k++) {
            ...
            cart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(cardView.this, order_placed, Toast.LENGTH_SHORT ).show();
